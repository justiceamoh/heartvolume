...
#################################
space = { 'i_units': scope.int(hp.uniform('units1',120,300)),
          'm_units': scope.int(hp.uniform('units2', 72,200)),
          'o_units': scope.int(hp.uniform('units3', 16,32)),

          # 'dropout1': hp.uniform('dropout1',.2,.5),
          # 'dropout2': hp.uniform('dropout2',.2,.5),

          'batch_size' : scope.int(hp.uniform('batch_size', 20, 30)),
...
param_df.to_csv("hyperparameters2.csv")
